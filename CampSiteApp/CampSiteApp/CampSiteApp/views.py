...
def search_api(request):
    ...
    if len(user_input) == 0:
        ...
        # Variables for formatting query string
        park_code = park_code[0]
        key = 'mJEOpAw6zq2D9gtJbecpvFkPecgRhHkf8HEWRLDH'
        path = 'https://developer.nps.gov'

        # API request for information about campgrounds at national park using park code compiled from user input
